...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            tabTitleView[i].setTextColor(getResources().getColorStateList(R.color.slidingtab_selector));
            tabTitleView[i].setTextSize(14);
        }
    }

    public void setTabTitleViewTextColor(ColorStateList color){
        for(TextView textview : tabTitleView){
